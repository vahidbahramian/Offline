...
namespace NS_DSP
{
	...
	public:
		...
		void Release();
		BOOL DoAMR(double *m_fSamples,double fs,int m_nNumberSamples,
			BOOL *m_bArrValidChunk,int m_nBlocks,int &modType);//without bpf
		int CarrierFreqIndex(double *m_fSamples,int m_nNumberSamples);
